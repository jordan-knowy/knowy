    ...
    <main className="min-h-screen bg-background text-foreground">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-neutral max-w-none space-y-8 text-sm leading-7">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3">Article 5 — Données personnelles</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3">Article 8 — Résiliation</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3">Article 9 — Modifications des CGU</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3">Article 10 — Droit applicable et juridiction</h2>
            <p>
