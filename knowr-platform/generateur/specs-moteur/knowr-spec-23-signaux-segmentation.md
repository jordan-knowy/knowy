...
>
> **Périmètre (cf. spec-30).** Cette spec gouverne le signal *unitaire* (le **fait** affiché : daté, sourcé, scopé, tagué). Le **scoring** d'un signal (sévérité, décroissance, polarité, défensabilité), sa **fusion** en déclencheurs nommés et la **priorisation** d'un portefeuille vivent dans **spec-30**. Les tags fermés de §R3 sont conservés tels quels — spec-30 n'en ajoute aucun.
